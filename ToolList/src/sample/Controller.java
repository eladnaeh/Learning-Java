...
//        TodoItem item4 = new TodoItem("Pickup Doug at the train station", "Dog's arriving on March 23 on the 5:00 train",
        ...
        todoListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TodoItem>() {
            ...
            public void changed(ObservableValue<? extends TodoItem> observable, TodoItem oldValue, TodoItem newValue) {
                if(newValue != null){
                    ...
                    DateTimeFormatter df = DateTimeFormatter.ofPattern("MMMM d, yyyy"); //another option: ("d M yy");
